...
const navItems = [
  ...
  { to: "/production", label: "Ishlab chiqarish", icon: Printer, module: "production" as ModuleKey },
  { to: "/pechatnik", label: "Pechatnik", icon: Stamp, module: "pechatnik" as ModuleKey },
...
export default function Sidebar({ mobileOpen, onCloseMobile }: Props) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-72 flex-col border-r border-ink-100 bg-surface transition-transform lg:static lg:translate-x-0 ${
