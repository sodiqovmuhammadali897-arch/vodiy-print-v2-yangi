...
const navItems = [
  ...
  { to: "/brands", label: "Brendlar", icon: Tag },
  { to: "/proposals", label: "Tijorat taklifi", icon: FileText },
  { to: "/design", label: "Dizayn", icon: Palette },
  { to: "/textile", label: "Textil", icon: Shirt },
